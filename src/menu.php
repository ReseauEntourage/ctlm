...
<div class="menu_ouvert">
    <ul>
        ...
        <a href="index.php" <?php if ($_GET['page']=='medias' or $_GET['page']=='actualites' or $_GET['page']=='partenaires' or $_GET['page']=='projections' or $_GET['page']=='filmequipe' or $_GET['page']=='contact'){ }else {echo 'class="active"';} ?>><li>Accueil</li></a>
...
<div class="menu">
    ...
    <ul>
        <li><a href="index.php" <?php if ($_GET['page']=='medias' or $_GET['page']=='actualites' or $_GET['page']=='partenaires' or $_GET['page']=='projections' or $_GET['page']=='filmequipe' or $_GET['page']=='contact'){ }else {echo 'class="active"';} ?>>Accueil</a></li>
